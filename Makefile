...
ohg1: OHG.cpp Walls.cpp Player.cpp GameEntity.cpp Game.cpp Enemy.cpp WallPos.txt
	clang++  -Wall -Werror OHG.cpp Walls.cpp Player.cpp GameEntity.cpp Game.cpp Enemy.cpp $(LIB)  -o t -L/usr/local/Cellar/sfml/2.5.1_1/lib -lsfml-graphics -lsfml-window -lsfml-system
